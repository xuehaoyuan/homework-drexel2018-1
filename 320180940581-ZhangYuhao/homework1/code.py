...
getting the commit count per sublevel pointwise or cumulative (c) .
And the arguments is the tag as displayed by git tag and the number
of sublevels to be counted. If count is out of range for a 
specific sublevel it will not terminate the loop.
'''
__copyright__ = "2020, Lanzhou University"
__license__ = 'GPLV2'
__author__ = "Zhang Yuhao(320180940581)"
__email__ = "yuhaozhang18@lzu.edu.cn"
__status__ = "homework1"
